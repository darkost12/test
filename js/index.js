...
window.onload=function(){
	...
	function change_time(){
		let volume_saved = document.getElementById('music_player').volume;
		document.getElementById('music_player').pause();
		document.getElementById('music_player').volume=0;
		...
		document.getElementById('music_player').play();
		document.getElementById('music_player').volume=volume_saved;
	};
